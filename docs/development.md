...
Если при классическом подходе торомизить будут все операции, то при использовании `eventsourcing` тормозить будет только начальная загрузка, зато остальное будет значительно быстрее.
